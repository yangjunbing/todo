        ...
        <div class="main-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tr id="tr_${queue.id}">
                                    <td class="center">
                                        <button class="btn btn-xs btn-success" onclick="callNumber('${queue.id}','${queue.rightnow}')">
                                            <i class="icon-bullhorn bigger-120"></i>
                                        </button>
                                    </td>
                    ...
                    <div class ="col-md-4" id="rightForm" hidden="true" >
                    <form id="queuesform" class="form-horizontal" style="border:thin solid #e5e5e5; border-radius: 3px">
                        ...
                        <input type="hidden" name="rightnow" id="rightnow"  />
                        <div class="form-group">
                            <div class="space-6"></div>
                            <label  class="col-sm-2 control-label">座位</label>
                            <div class="col-sm-9">
                                <input type="text" name="tableNumber" class="form-control" id="tableNumber" placeholder="请输入座位号">
                            </div>
                        </div>
                        <button type="button"  onclick="addOrEdit(this.form)" class="btn btn-success btn-lg btn-block" id="btn_add">确定</button>
                        <div class="space-6"></div>
                    </form>
                    </div>
                </div>
...
<script type="application/javascript">
    ...
    function addOrEdit(form){
        if(form.tableNumber.value == ""){
           $('#info').text = ("请输入座位号");
            $('#info').show();
            return;
        }
        var id = form.queueid.value;
        var rightnow = form.rightnow.value;
        var tableNumber = form.tableNumber.value;
        $.ajax({
            url:   "<%=ctx%>/queues/callNumber?queueid="+id +"&rightnow="+ rightnow +"&tableNumber="+tableNumber,
            async: false,
            type:  "POST",
    ...
    //叫号
    function  callNumber(queueid,rightnow){
        console.log(queueid+"+"+rightnow);
        $('#queueid').val(queueid);
        $('#rightnow').val(rightnow);
        $('#rightForm').show(true);
