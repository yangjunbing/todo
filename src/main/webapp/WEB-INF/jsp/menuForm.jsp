    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <c:forEach var="menu" items="${list}" varStatus="index">
                    <li>
                        <a href="<%=ctx%>${menu.url}" >
                            <i class="icon-list"></i>
                    ...
                    <div class ="col-md-4">
                        <form id="menuform" class="form-horizontal" style="border:thin solid #e5e5e5; border-radius: 3px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" class="form-control" id="name" placeholder="请输入菜单名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="space-6"></div>
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="url" class="form-control" id="url" placeholder="请输入url">
                                </div>
                            </div>
                            <div class="form-group">
